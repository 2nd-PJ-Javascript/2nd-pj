...
$startDayIsSunday.addEventListener("click", function(){
  ...
  $datesOfWeek.children[5].textContent = $datesOfWeek.children[4].textContent;
  $datesOfWeek.children[4].textContent = $datesOfWeek.children[3].textContent;
  $datesOfWeek.children[3].textContent = $datesOfWeek.children[2].textContent;
  $datesOfWeek.children[2].textContent = $datesOfWeek.children[1].textContent;
  $datesOfWeek.children[1].textContent 
