...
document.querySelector('.colors').addEventListener('click', function(e){
  ...
  if(target === $themeColor1){ //첫번째 테마 클릭 시 
    ...
    $header.setAttribute("style", "background: beige;"); //헤더 배경색 핑크색으로 변경
    $header.setAttribute("style","color: brown");
    document.body.setAttribute("style","background: brown;"); //바디 배경색 흰색으로 변경
