...
const $themeColor2 = document.querySelector('.theme-color1');
const $themeColor3 = document.querySelector('.theme-color1');
const $themeColor4 = document.querySelector('.theme-color1');
